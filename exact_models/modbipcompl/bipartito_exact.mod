...
#-------- usando queste meno nodi ma piu' tempo (dico quelli a 1 ok, gli altri a 0)

#subject to assignment {u in V: u>cl} : sum{k in K} y[u,k] = 1; 
#subject to sym_break1plus{u in V, l in K : u <= cl and l>u}: y[u,l]=0; 

#----------------------------



#--- va bene se ho piu' clusters di quelli che ci sono davvero
